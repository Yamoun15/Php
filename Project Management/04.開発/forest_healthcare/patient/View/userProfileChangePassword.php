        ...
        <div class="row">
            ...
            <div class="col-md-7  col-sm-8 adminContact-col">
                <form action="" class="form-horizontal hr adminContact-form">
                    <div class="myProfileTitle">Change Password</div>
                    <div class="form-group userProfileInputfloat">
                        <div class="col-md-12">
                            <input type="text" class="form-control adminContactInput" id="usernaem" placeholder="Current Password">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" class="form-control adminContactInput" id="usernaem" placeholder="New Password">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
