...
<head>
    ...
    <link rel="stylesheet" href="./css/adminContactReply.css">
...
<body class="mainContactReplybgcolor">
    <div class="container">
        <div class="row mt-5 mb-3">
            <div class="col-md-3 col-sm-2 col-2"></div>
            <div class="col-md-6 col-sm-8 col-8 adminContactReply-col adminReplytitle">Contact Us Mail Reply</div>
            <div class="col-md-3 col-sm-2 col-2"></div>
        </div>
        <div class="row">
            <div class="col-md-3 col-sm-2 col-2"></div>
